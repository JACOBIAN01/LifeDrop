      ...
      <div className="min-h-screen bg-gradient-to-br from-rose-50 to-red-50 py-10 px-4">
        <div className="max-w-3xl mx-auto bg-white shadow-2xl rounded-3xl p-8 animate-fadeIn">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full flex items-center justify-center bg-gradient-to-r from-rose-500 to-red-500 text-white py-3 rounded-2xl hover:scale-105 transform transition duration-300"
            >
              <Droplet className="w-5 h-5 mr-2" /> Submit Blood Request
            </button>
          </form>
        </div>
      </div>
